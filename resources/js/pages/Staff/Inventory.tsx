...
const getStatusBadge = (status: string) => {
    const styles: Record<string, string> = {
        'active': "bg-gradient-to-r from-[#ff1a1a] to-[#ff3333] text-white shadow-lg",
...
const getStockStatus = (item: InventoryItem) => {
    if (item.stock_quantity === 0) {
        return <span className="bg-red-100 text-red-800 text-xs font-semibold px-2 py-1 rounded-full flex items-center">
            <XCircle className="h-3 w-3 mr-1" />
            Out of Stock
        </span>;
    } else if (item.stock_quantity <= item.minimum_stock) {
        return <span className="bg-yellow-100 text-yellow-800 text-xs font-semibold px-2 py-1 rounded-full flex items-center">
            <AlertTriangle className="h-3 w-3 mr-1" />
            Low Stock
        </span>;
    } else {
        return <span className="bg-green-100 text-green-800 text-xs font-semibold px-2 py-1 rounded-full flex items-center">
    ...
    return (
        <div className="bg-white rounded-xl p-4 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
            <div className="flex items-center justify-between">
                ...
                <div className={`${color} p-2 rounded-lg shadow-lg`}>
    ...
    return (
        <div className="fixed inset-0 z-50 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4">
                ...
                <div className="relative w-full max-w-4xl transform overflow-hidden rounded-xl bg-white shadow-2xl transition-all max-h-[90vh] overflow-y-auto">
                    ...
                    <form onSubmit={handleSubmit} className="p-4 space-y-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="relative">
                                ...
                                <div className="relative">
                                    <div className="relative">
                                        <input
                                            ref={skuInputRef}
                                            type="text"
                                            className={`w-full px-3 py-2 pl-10 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#ff1a1a] focus:border-transparent transition-all ${
                                        ...
                                        >
                                            {filteredItems.map((filteredItem) => (
                                                ...
                                                >
                                                    <div className="flex items-center justify-between">
                                                        <div className="flex-1">
                                                            <div className="font-semibold text-gray-900 text-sm">{filteredItem.name}</div>
                                                        ...
                                                        <div className="ml-4 text-right">
                                                            <div className="text-sm font-semibold text-[#ff1a1a]">
                                ...
                                <div className="mt-2">
                                    ...
                                    <div className="relative">
                                        <input
                                            type="text"
                                            className={`w-full px-3 py-2 pl-10 border-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#ff1a1a] focus:border-transparent transition-all font-mono ${
                                                formData.sku 
                            ...
                            <div>
                                ...
                                <input
                                    type="text"
                                    className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#ff1a1a] focus:border-transparent transition-all ${
                        ...
                        <div className="flex justify-end space-x-2 pt-4 border-t">
                            ...
                            <button
                                type="submit"
                                className="px-4 py-2 bg-gradient-to-r from-[#ff1a1a] to-[#ff3333] text-white rounded-lg hover:shadow-lg transition-all font-medium flex items-center"
                        ...
                        <div className="bg-gray-50 rounded-lg p-3 border border-gray-200">
                            <div className="flex items-center justify-between">
                                ...
                                <div className="text-right">
                                    ...
                                    <p className="text-lg font-bold text-gray-900">{item.stock_quantity} {item.unit}</p>
                                </div>
                            </div>
                        </div>
                                ...
                                <button
                                    ...
                                    className={`px-3 py-2 rounded-lg font-medium transition-all ${
                                        adjustmentData.type === 'adjustment'
                                            ? 'bg-[#ff1a1a] text-white shadow-lg'
                                            : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                                    }`}
                                    disabled={formLoading}
                                >
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <span className="text-base font-bold text-blue-600">
                                        ...
                                        {newStock <= item.minimum_stock && (
                                            <AlertTriangle className="inline h-3 w-3 ml-2 text-yellow-600" />
                                        )}
                                    </span>
                                </div>
                            </div>
                    ...
                    <div className="p-4">
                        <div className="mb-4">
                            ...
                            <div className="bg-red-50 border border-red-200 rounded-lg p-3">
                                ...
                                <div className="text-xs text-gray-500">Stock: {item.stock_quantity} {item.unit}</div>
                            </div>
                        </div>
                        ...
                        <div className="flex justify-end space-x-2">
                            ...
                            <button
                                onClick={onConfirm}
                                className="px-4 py-2 bg-gradient-to-r from-red-600 to-red-700 text-white rounded-lg hover:shadow-lg transition-all font-medium flex items-center"
                                disabled={loading}
                            >
                                {loading ? (
                                    <>
            ...
            for (let batchIndex = 0; batchIndex < batches.length; batchIndex++) {
                ...
                await Promise.all(batch.map(async (item, itemIndex) => {
                    ...
                    try {
                        ...
                        results.failed++;
                        const errorMsg = 'Row ' + (currentIndex + 2) + ' (SKU: ' + item.sku + '): ' + (error.message || 'Unknown error');
...
const Notification = ({ 
    ...
    const bgColors = {
        success: 'bg-gradient-to-r from-[#ff1a1a] to-[#ff3333] border-[#ff1a1a]',
    ...
    return (
        <div className="fixed bottom-4 right-4 z-50 animate-slide-up">
            <div className={`${bgColors[type]} border-l-4 rounded-lg shadow-xl p-3 min-w-[250px] max-w-sm`}>
                <div className="flex items-center justify-between">
        ...
        <head>
            ...
            <style>
                ...
                * { margin: 0; padding: 0; box-sizing: border-box; }
                ...
                .header { text-align: center; padding: 20px 0; border-bottom: 3px solid #00c951; margin-bottom: 20px; }
                ...
                .summary { background: #dcfce7; border: 2px solid #00c951; border-radius: 8px; padding: 15px; margin-bottom: 20px; display: grid; grid-template-columns: repeat(4, 1fr); gap: 15px; }
                .summary-item { text-align: center; }
                .summary-item .label { font-size: 8pt; color: #666; margin-bottom: 5px; }
                .summary-item .value { font-size: 16pt; font-weight: bold; color: #00c951; }
                table { width: 100%; border-collapse: collapse; margin-bottom: 20px; font-size: 7.5pt; }
                thead { background: #00c951; color: white; }
                th { padding: 8px 4px; text-align: left; font-size: 7.5pt; font-weight: bold; border: 1px solid #00a642; }
                td { padding: 5px 4px; border: 1px solid #ddd; font-size: 7.5pt; }
                tbody tr:nth-child(even) { background: #f9fafb; }
                .no-data { text-align: center; padding: 40px; color: #666; font-style: italic; }
                .footer { position: fixed; bottom: 0; left: 0; right: 0; padding: 15px 20mm; border-top: 2px solid #00c951; background: white; font-size: 7pt; color: #666; }
                .footer-content { display: flex; justify-content: space-between; align-items: center; }
                .footer strong { color: #00c951; }
...
<body>
    ...
    const fetchOutOfStockItems = async () => {
        try {
            ...
            const response = await inventoryService.getItems({
                page: 1,
                per_page: 1000 // Get all items to filter
            });
            ...
            if (response.success && response.data) {
                ...
                setOutOfStockItems([]);
                setNotification({ type: 'warning', message: 'Unable to fetch out of stock items' });
            }
        } catch (error: any) {
    ...
    const handleShowOutOfStock = () => {
        try {
            ...
            console.error('Error opening out of stock view:', error);
            setNotification({ type: 'error', message: 'Failed to open out of stock view' });
        }
    };
            ...
            <div className="flex items-center justify-between px-4 py-3 border-t border-gray-200 bg-white">
                ...
                <div className="flex items-center space-x-1">
                    ...
                    {startPage > 1 && (
                        <>
                            <button
                                ...
                                className="px-2 py-1.5 rounded-lg border border-gray-300 hover:bg-gray-50 transition-colors"
                            >
                                1
                            </button>
                    ...
                    {endPage < pagination.last_page && (
                        <>
                            {endPage < pagination.last_page - 1 && <span className="px-1 text-gray-500">...</span>}
                            <button
                    ...
                    <div className="mb-6">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-gray-500 text-sm">Manage your inventory items and stock levels</p>
                            </div>
                            <div className="flex space-x-2">
                                <button 
                                    onClick={handleShowQuotation}
                                    className="px-3 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors flex items-center shadow-lg"
                                >
                                ...
                                <button 
                                    ...
                                    className="px-3 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors flex items-center shadow-lg"
                                >
                                ...
                                <button 
                                    ...
                                    className="px-3 py-2 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors flex items-center shadow-lg"
                                >
                    ...
                    {stats && (
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                            <StatsCard
                                ...
                                icon={Package}
                                color="bg-gradient-to-br from-[#ff1a1a] to-[#ff3333]"
                            />
                            <StatsCard
                                title="Low Stock"
                        ...
                        <div className="flex flex-col md:flex-row gap-3">
                            <div className="flex-1 relative">
                                <input
                                    ...
                                    className="w-full pl-10 pr-3 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#ff1a1a] focus:border-transparent transition-all"
                                />
                                <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-gray-400" />
                            </div>
                            <select
                                ...
                                className="px-3 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#ff1a1a] focus:border-transparent transition-all"
                            >
                                            ...
                                            <tr key={item.id} className="hover:bg-gray-50 transition-colors">
                                                <td className="px-4 py-3 whitespace-nowrap">
                                                    <div className="flex items-center">
                                                        <div className="flex-shrink-0 h-8 w-8 bg-gradient-to-br from-[#ff1a1a] to-[#ff3333] rounded-lg flex items-center justify-center">
                                                ...
                                                <td className="px-4 py-3 whitespace-nowrap">
                                                    {item.batch_number ? (
                                                        <div className="flex flex-col">
                                                            <span className="text-sm font-medium text-gray-900 bg-blue-50 px-2 py-1 rounded-md border border-blue-200">
                                                                {item.batch_number}
                                                            </span>
                                                            {item.expiry_date && (
                                                        ...
                                                        <span className="text-sm text-gray-400 italic">No batch</span>
                                                    )}
                                                </td>
                                                <td className="px-4 py-3 whitespace-nowrap">
