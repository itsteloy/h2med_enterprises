...
export default function PointOfSalePage() {
    ...
    const fetchProducts = async () => {
        ...
        try {
            ...
            // Filter to show only products with stock (stock_quantity > 0)
        ...
        return (
            <div className="fixed inset-0 z-50 overflow-y-auto">
                <div className="flex min-h-full items-center justify-center p-4">
                    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm transition-opacity" onClick={() => setShowDiscountOptions(false)}></div>
                    ...
                    className="relative w-full max-w-md transform overflow-hidden rounded-2xl bg-white shadow-2xl transition-all max-h-[90vh] flex flex-col">
                        <div className="bg-[#00c951] px-6 py-4 flex-shrink-0">
                        ...
                        <div className="p-6 space-y-4 overflow-y-auto flex-1">
                            <div className="p-4 border rounded-xl">
                                <div className="flex items-center justify-between mb-3">
                                    <div className="flex items-center">
                                        ...
                                        <div>
                                            <h3 className="font-medium text-gray-900">Senior Citizen</h3>
                                            <p className="text-sm text-gray-500">Discount (ID Required)</p>
                                        </div>
                                    </div>
                                    <input
                                        type="checkbox"
                                        ...
                                        className="w-5 h-5 text-[#00c951] rounded"
                                    />
                                </div>
                                {isSeniorCitizen && (
                                    <div className={`space-y-4 ${isSeniorCitizen ? 'block' : 'hidden'}`}>
                                        <div>
                                            ...
                                            <div className="relative">
                                                <input
                                                    ...
                                                    onChange={(e) => setSeniorDiscountInput(e.target.value)}
                                                    className="w-full px-4 py-3 pr-12 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#00c951] focus:border-transparent transition-all"
                                                    placeholder="20"
                                                />
                                        ...
                                        <div>
                                            <label className="block text-sm font-medium text-gray-700 mb-2">Senior Citizen ID *</label>
                                            <input
                                                type="text"
                                                value={seniorId}
                            ...
                            <div className="p-4 border rounded-xl">
                                <div className="flex items-center justify-between mb-3">
                                    <div className="flex items-center">
                                        ...
                                        <div>
                                            <h3 className="font-medium text-gray-900">PWD</h3>
                                            <p className="text-sm text-gray-500">Discount (ID Required)</p>
                                        </div>
                                    </div>
                                    <input
                                ...
                                {isPWD && (
                                    <div className={`space-y-4 ${isPWD ? 'block' : 'hidden'}`}>
                                        <div>
                                            <label className="block text-sm font-medium text-gray-700 mb-2">Discount Percentage</label>
                                            <div className="relative">
                                                <input
                                                    ...
                                                    onChange={(e) => setPwdDiscountInput(e.target.value)}
                                                    className="w-full px-4 py-3 pr-12 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#00c951] focus:border-transparent transition-all"
                                                    placeholder="20"
                                                />
                                                <div className="absolute inset-y-0 right-0 pr-4 flex items-center pointer-events-none">
                                        ...
                                        <div>
                                            <label className="block text-sm font-medium text-gray-700 mb-2">PWD ID *</label>
                                            <input
                                                type="text"
                                                value={pwdId}
                            ...
                            <div className="p-4 border rounded-xl">
                                <div className="flex items-center mb-4">
                                    ...
                                    <h3 className="font-medium text-gray-900">General Discount</h3>
                                </div>
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-2">Discount Percentage</label>
                                    <div className="relative">
                                        <input
                                            ...
                                            className="w-full px-4 py-3 pr-12 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#00c951] focus:border-transparent transition-all"
                                            placeholder="0"
                                            autoFocus={!isSeniorCitizen && !isPWD}
                                            autoComplete="off"
                                            spellCheck={false}
                                        />
                                        <div className="absolute inset-y-0 right-0 pr-4 flex items-center pointer-events-none">
                                    ...
                                    <p className="text-xs text-gray-500 mt-2">Maximum 50% discount allowed</p>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-4 gap-2">
                                {[5, 10, 15, 25].map(rate => (
                                    <button
                                        key={rate}
                                        onClick={() => {
                                            setGeneralDiscountRate(rate);
                                            setGeneralDiscountInput(rate.toString());
                                            setIsSeniorCitizen(false);
                                            setIsPWD(false);
                                            setSeniorId('');
                                            setPwdId('');
                        ...
                        <div className="flex justify-end space-x-3 p-6 pt-0 flex-shrink-0 border-t border-gray-100">
                            <button
                                onClick={() => {
                                    // Validate and apply discounts only when Apply is clicked
                                    if (isSeniorCitizen) {
                                        const seniorValue = parseFloat(seniorDiscountInput) || 0;
                                        const clampedSenior = Math.min(100, Math.max(0, seniorValue));
                                        setSeniorDiscountRate(clampedSenior);
                                        setSeniorDiscountInput(clampedSenior.toString());
                                    }

                                    if (isPWD) {
                                        const pwdValue = parseFloat(pwdDiscountInput) || 0;
                                        const clampedPwd = Math.min(100, Math.max(0, pwdValue));
                                        setPwdDiscountRate(clampedPwd);
                                        setPwdDiscountInput(clampedPwd.toString());
                                    }

                                    if (!isSeniorCitizen && !isPWD && generalDiscountInput) {
                                        const generalValue = parseFloat(generalDiscountInput) || 0;
                                        const clampedGeneral = Math.min(50, Math.max(0, generalValue));
                                        setGeneralDiscountRate(clampedGeneral);
                                        setGeneralDiscountInput(clampedGeneral.toString());

                                        // Clear other discounts if general discount has a value
                                        if (clampedGeneral > 0) {
                                            setIsSeniorCitizen(false);
                                            setIsPWD(false);
                                            setSeniorId('');
                                ...
                                className="px-6 py-2 bg-[#00c951] text-white rounded-xl hover:bg-[#00b048] transition-all font-medium"
                            >
                                Apply
                            </button>
                        </div>
                    ...
                    <div className="relative w-full max-w-md transform overflow-hidden rounded-2xl bg-white shadow-2xl transition-all">
                        ...
                        <div className="p-6">
                            <div className="text-center mb-4">
                                <h3 className="text-xl font-bold">H2-MED Enterprises</h3>
                        ...
                        <div className="flex justify-center space-x-3 p-6 pt-0">
                            <button
                                ...
                                className="inline-flex items-center px-4 py-2 bg-[#00c951] text-white rounded-xl hover:bg-[#00b048] transition-all font-medium"
                            >
                    ...
                    <div className="mb-6 flex flex-col md:flex-row md:items-center md:justify-between">
                        <div className="flex items-center mb-4 md:mb-0">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600">Process sales transactions</p>
                            </div>
                        </div>
                        <div className="flex space-x-2">
                            <Link href="/admin/purchases" className="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-all text-sm font-medium">
                                <Eye className="h-4 w-4 mr-2" />
                                View Purchases
                            </Link>
                            <button
                                onClick={clearCart}
                                className="inline-flex items-center px-4 py-2 bg-white border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-all text-sm font-medium"
                            >
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                                            {Array.isArray(products) && products.map((product) => (
                                                ...
                                                >
                                                    ...
                                                    <h3 className="font-semibold text-gray-900 text-xs mb-1 truncate">{product.name}</h3>
                                                    <p className="text-xs text-gray-500">{product.category?.name || 'No Category'}</p>
                                                    <p className="text-xs text-gray-500 mb-1">SKU: {product.sku}</p>
                                                    <div className="flex justify-between items-center">
                                                        <span className="text-sm font-bold text-[#ff1a1a]">
                                                            ₱{ensureNumber(product.price).toFixed(2)}
                                                        </span>
                                                        <button
                                                            className="w-6 h-6 bg-[#ff1a1a] text-white rounded-full flex items-center justify-center hover:bg-[#cc0000] transition-colors"
                                                            onClick={(e) => {
                                                                e.stopPropagation();
                                                                addToCart(product);
                                                            }}
                                        ...
                                        <div className="text-center py-8">
                                            ...
                                            <p className="text-gray-500 text-sm">
                                                {searchTerm || selectedCategory !== 'All' 
                                                    ? 'No products with stock found matching your search criteria.' 
                                                    : 'No products with stock available.'}
                                            </p>
                                            <p className="text-gray-400 text-xs mt-1">
                                                Products with zero stock are hidden from view.
                                            </p>
                                        </div>
                                    )}
                                </div>
                                ...
                                <div className="p-4">
                                    ...
                                    {(isSeniorCitizen || isPWD || generalDiscountRate > 0) && (
                                        <div className="mb-3 p-2 bg-green-50 border border-green-200 rounded-lg">
                                            <div className="flex items-center justify-between">
                                                <div className="flex items-center">
                                                    <Percent className="h-3 w-3 text-green-600 mr-2" />
                                            ...
                                            Array.isArray(cart) && cart.map((item) => item && (
                                                <div key={item.id} className="flex items-center justify-between p-3 bg-white border border-gray-100 rounded-xl shadow-sm hover:shadow-md transition-all">
                                                    <div className="flex-1 min-w-0 mr-3">
                                                        <h3 className="font-semibold text-gray-900 text-xs truncate">{item.name || 'Unknown Item'}</h3>
